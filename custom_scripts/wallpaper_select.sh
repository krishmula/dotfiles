...
if [ -n "$selected_image_path" ]; then
  ln -sf "$selected_image_path" ~/Pictures/wallpapers/wallpaper.png
  ...
  notify-send -a "Wallpaper selector" "Wallpaper changed" "$selected_image_path" -i ~/Pictures/wallpapers/wallpaper.png
